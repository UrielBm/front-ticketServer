...
esta es una app que tiene comunicación en tiempo real con su backend para simular las entradas de ticket de tiendas y bancos y como son atendidos por diferentes gerentes.
...
**Dirección del Link**: [Link-Demo](https://front-ticket-app.vercel.app/)
